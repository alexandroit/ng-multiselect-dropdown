...
> A maintained **Angular 17 multi-select dropdown component** with support for template-driven forms, reactive forms, primitive or object data sources, built-in search, selection limits, disabled items, and versioned docs for every maintained Angular line.
...
| Feature | Supported |
| :--- | :---: |
| Angular 17 maintained release line | ✅ |
